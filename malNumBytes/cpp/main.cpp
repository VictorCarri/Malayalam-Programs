...
/* Our headers */
#include "vuh/LenCounter.hpp" // Functor that counts the # of Unicode chars. in a string
...
int main(int argc, char* argv[])
{
	...
	vuh::LenCounter ulc; // Functor that counts the # of Unicode characters in an std::string
	vuh::LenCounter ulc2; // Functor that counts the # of Unicode characters in an std::wstring
	...
	*/
	...
	else
	{
		...
		else
		{
			...
			catch (std::logic_error& countErr) // An error occurred while counting the # of codepoints in this string
			{
				//std::cerr << ourName;
				std::wcerr << ourNameW;
