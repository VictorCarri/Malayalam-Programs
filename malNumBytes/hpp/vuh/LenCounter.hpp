#ifndef VUH_LENCOUNTER_HPP
#define VUH_LENCOUNTER_HPP
...
/*
* A namespace for my unicode helper classes. Used so that my library can live in its own namespace.
*/
namespace vuh
{
	/**
