...
.LBB312:
	...
	leaq	8(%rdi), %rax
	movq	$_ZTCN3mpp10exceptions7DBErrorE0_NS0_9ExceptionE+72, 8(%rdi)
.LVL2:
...
.LBB321:
	...
	leaq	8(%rsi), %rsi
.LVL13:
	.loc 3 13 104 view .LVU19
	call	_ZN3mpp10exceptions9ExceptionC2EPc
.LVL14:
	.loc 3 13 104 view .LVU20
	movq	0(%rbp), %rax
	movq	%rax, (%rbx)
	movq	24(%rbp), %rdx
	movq	-24(%rax), %rax
...
.LFB1377:
	...
	movq	%rsi, %rbp
.LBB322:
	.loc 3 13 104 view .LVU26
	leaq	8(%rdi), %r12
	movq	%r12, %rdi
.LVL18:
.LEHB0:
	.loc 3 13 104 view .LVU27
	call	_ZNSt11logic_errorC2EPKc
.LVL19:
.LEHE0:
	.loc 3 13 104 view .LVU28
	movq	%rbp, %rdx
	movl	$_ZTTN3mpp10exceptions7DBErrorE+8, %esi
	movq	%rbx, %rdi
.LEHB1:
	call	_ZN3mpp10exceptions9ExceptionC2EPc
.LVL20:
.LEHE1:
	.loc 3 13 104 discriminator 2 view .LVU29
	movq	$_ZTVN3mpp10exceptions7DBErrorE+24, (%rbx)
	movq	$_ZTVN3mpp10exceptions7DBErrorE+72, 8(%rbx)
.LBE322:
...
.LFB1380:
	...
	movq	%rsi, %rbp
.LBB407:
	.loc 3 21 110 view .LVU173
	leaq	8(%rdi), %r12
	movq	%r12, %rdi
.LVL73:
.LEHB6:
	.loc 3 21 110 view .LVU174
...
.LBE409:
.LBE408:
	.loc 3 21 110 discriminator 2 view .LVU209
	movq	%rsp, %rdx
	movl	$_ZTTN3mpp10exceptions7DBErrorE+8, %esi
	movq	%rbx, %rdi
.LEHB8:
...
.LBE460:
.LBE448:
	.loc 3 21 110 discriminator 1 view .LVU252
	movq	%r12, %rdi
	call	_ZNSt11logic_errorD2Ev
.LVL92:
	movq	%rbx, %rdi
...
.LEHE9:
.L37:
	.loc 3 21 110 discriminator 1 view .LVU253
	movq	%rax, %rbx
.LVL94:
	.loc 3 21 110 discriminator 1 view .LVU254
	jmp	.L36
.LBE463:
	.cfi_endproc
.LFE1380:
...
_ZTSN3mpp10exceptions7DBErrorE:
	...
	.size	_ZTIN3mpp10exceptions7DBErrorE, 24
...
_ZTTN3mpp10exceptions7DBErrorE:
	...
	.size	_ZTVN3mpp10exceptions7DBErrorE, 96
...
.Ldebug_info0:
	...
	.uleb128 0x9
	.byte	0x3
	.quad	_ZTTN3mpp10exceptions7DBErrorE+8
	.uleb128 0x19
	.uleb128 0x1
	.byte	0x51
	.uleb128 0x2
