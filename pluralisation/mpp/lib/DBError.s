...
.LBB182:
	...
	movq	$_ZTVN3mpp10exceptions7DBErrorE+24, (%rdi)
	movq	$_ZTVN3mpp10exceptions7DBErrorE+72, 8(%rdi)
.LVL1:
.LBB183:
.LBI183:
...
.LVL21:
.LEHE1:
	.loc 3 13 104 discriminator 2 view .LVU30
	movq	$_ZTVN3mpp10exceptions7DBErrorE+24, (%rbx)
	movq	$_ZTVN3mpp10exceptions7DBErrorE+72, 8(%rbx)
.LBE194:
...
.LFB1242:
	...
	movq	%rsi, %rbp
.LBB304:
	.loc 3 21 110 view .LVU94
	leaq	8(%rdi), %r12
	movq	%r12, %rdi
.LVL53:
.LEHB3:
	.loc 3 21 110 view .LVU95
...
.LBE353:
.LBE347:
	.loc 3 21 110 discriminator 1 view .LVU162
	movq	%r12, %rdi
	call	_ZNSt11logic_errorD2Ev
.LVL70:
	movq	%rbx, %rdi
...
.LEHE6:
.L29:
	.loc 3 21 110 view .LVU163
	movq	%rax, %rbx
.LVL72:
	.loc 3 21 110 view .LVU164
	jmp	.L28
.LBE354:
	.cfi_endproc
.LFE1242:
