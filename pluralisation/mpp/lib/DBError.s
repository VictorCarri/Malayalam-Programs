...
.LBB245:
	leaq	24+_ZTCN3mpp10exceptions7DBErrorE0_NS0_9ExceptionE(%rip), %rax
	movq	%rax, (%rdi)
	leaq	8(%rdi), %rax
	leaq	72+_ZTCN3mpp10exceptions7DBErrorE0_NS0_9ExceptionE(%rip), %rdx
	movq	%rdx, 8(%rdi)
.LVL2:
...
.LEHE0:
	...
	movq	%rbp, %rdx
	movq	_ZTTN3mpp10exceptions7DBErrorE@GOTPCREL(%rip), %rax
	leaq	24(%rax), %rsi
	movq	%rbx, %rdi
.LEHB1:
...
.LEHE1:
	...
	movq	_ZTVN3mpp10exceptions7DBErrorE@GOTPCREL(%rip), %rax
	leaq	40(%rax), %rdx
	movq	%rdx, (%rbx)
	leaq	88(%rax), %rax
	movq	%rax, 8(%rbx)
...
.LBE286:
.LBE285:
	.loc 3 21 110 discriminator 2 view .LVU130
	movq	%rsp, %rdx
	movq	_ZTTN3mpp10exceptions7DBErrorE@GOTPCREL(%rip), %rax
	leaq	24(%rax), %rsi
	movq	%rbx, %rdi
...
.LBE337:
.LBE325:
	.loc 3 21 110 discriminator 1 view .LVU173
	movq	%r12, %rdi
	call	_ZNSt11logic_errorD2Ev@PLT
.LVL71:
	movq	%rbx, %rdi
...
.LEHE6:
.L30:
	.loc 3 21 110 discriminator 1 view .LVU174
	movq	%rax, %rbx
.LVL73:
	.loc 3 21 110 discriminator 1 view .LVU175
	jmp	.L29
.LBE340:
	.cfi_endproc
.LFE1380:
...
_ZTSN3mpp10exceptions7DBErrorE:
	...
	.section	.data.rel.ro._ZTIN3mpp10exceptions7DBErrorE,"awG",@progbits,_ZTIN3mpp10exceptions7DBErrorE,comdat
	.align 8
...
_ZTIN3mpp10exceptions7DBErrorE:
	...
	.section	.data.rel.ro._ZTCN3mpp10exceptions7DBErrorE0_NS0_9ExceptionE,"awG",@progbits,_ZTVN3mpp10exceptions7DBErrorE,comdat
	.align 8
...
_ZTCN3mpp10exceptions7DBErrorE0_NS0_9ExceptionE:
	...
	.section	.data.rel.ro._ZTTN3mpp10exceptions7DBErrorE,"awG",@progbits,_ZTVN3mpp10exceptions7DBErrorE,comdat
	.align 8
...
_ZTTN3mpp10exceptions7DBErrorE:
	...
	.section	.data.rel.ro._ZTVN3mpp10exceptions7DBErrorE,"awG",@progbits,_ZTVN3mpp10exceptions7DBErrorE,comdat
	.align 8
