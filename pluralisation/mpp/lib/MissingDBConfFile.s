...
.LBB182:
	...
	movq	$_ZTVN3mpp10exceptions17MissingDBConfFileE+24, (%rdi)
	movq	$_ZTVN3mpp10exceptions17MissingDBConfFileE+72, 8(%rdi)
.LVL1:
.LBB183:
.LBI183:
...
.LFB1709:
	...
	movq	(%rdi), %rax
	addq	-24(%rax), %rbx
	movq	$_ZTVN3mpp10exceptions17MissingDBConfFileE+24, (%rbx)
	movq	$_ZTVN3mpp10exceptions17MissingDBConfFileE+72, 8(%rbx)
...
.LFB1241:
	...
	.cfi_startproc
	.loc 3 20 1 is_stmt 0 view .LVU18
	pushq	%rbp
	.cfi_def_cfa_offset 16
	.cfi_offset 6, -16
	pushq	%rbx
	...
	movq	%rsi, %rbp
.LBB193:
	.loc 3 20 133 view .LVU19
	leaq	8(%rsi), %rsi
.LVL14:
	.loc 3 20 133 view .LVU20
	call	_ZN3mpp10exceptions9ExceptionC2EPc
.LVL15:
	.loc 3 20 133 view .LVU21
	movq	0(%rbp), %rax
	movq	%rax, (%rbx)
	movq	24(%rbp), %rax
	movq	%rax, 8(%rbx)
.LBE193:
	.loc 3 22 1 view .LVU22
	addq	$8, %rsp
	.cfi_def_cfa_offset 24
	popq	%rbx
	.cfi_def_cfa_offset 16
...
.LFB1242:
	...
	.loc 3 20 1 is_stmt 0 view .LVU26
	pushq	%r12
	.cfi_def_cfa_offset 16
	.cfi_offset 12, -16
	pushq	%rbp
...
.LVL20:
.LEHE0:
	.loc 3 20 133 view .LVU29
	movq	%rbp, %rdx
	movl	$_ZTTN3mpp10exceptions17MissingDBConfFileE+8, %esi
	movq	%rbx, %rdi
.LEHB1:
	call	_ZN3mpp10exceptions9ExceptionC2EPc
.LVL21:
.LEHE1:
	.loc 3 20 133 discriminator 2 view .LVU30
	movq	$_ZTVN3mpp10exceptions17MissingDBConfFileE+24, (%rbx)
	movq	$_ZTVN3mpp10exceptions17MissingDBConfFileE+72, 8(%rbx)
.LBE194:
...
.LBE353:
.LBE347:
	.loc 3 13 139 discriminator 1 view .LVU162
	movq	%r12, %rdi
	call	_ZNSt11logic_errorD2Ev
.LVL70:
	movq	%rbx, %rdi
...
.LEHE6:
.L29:
	.loc 3 13 139 view .LVU163
	movq	%rax, %rbx
.LVL72:
	.loc 3 13 139 view .LVU164
	jmp	.L28
.LBE354:
	.cfi_endproc
.LFE1239:
...
_ZTSN3mpp10exceptions17MissingDBConfFileE:
	...
	.size	_ZTIN3mpp10exceptions17MissingDBConfFileE, 24
...
_ZTCN3mpp10exceptions17MissingDBConfFileE0_NS0_9ExceptionE:
	...
	.size	_ZTTN3mpp10exceptions17MissingDBConfFileE, 32
_ZTTN3mpp10exceptions17MissingDBConfFileE:
	.quad	_ZTVN3mpp10exceptions17MissingDBConfFileE+24
	...
	.quad	_ZTVN3mpp10exceptions17MissingDBConfFileE+72
	...
	.size	_ZTVN3mpp10exceptions17MissingDBConfFileE, 96
...
.Ldebug_info0:
	...
	.uleb128 0x9
	.byte	0x3
	.quad	_ZTTN3mpp10exceptions17MissingDBConfFileE+8
	.uleb128 0x10
	.uleb128 0x1
	.byte	0x51
	.uleb128 0x2
