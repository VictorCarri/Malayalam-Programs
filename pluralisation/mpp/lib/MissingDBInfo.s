...
.LBB245:
	...
	leaq	8(%rdi), %rax
	movq	$_ZTCN3mpp10exceptions13MissingDBInfoE0_NS0_9ExceptionE+72, 8(%rdi)
.LVL2:
...
.LFB1377:
	...
	movq	%rsi, %rbp
.LBB284:
	.loc 3 13 122 view .LVU94
	leaq	8(%rdi), %r12
	movq	%r12, %rdi
.LVL52:
.LEHB3:
	.loc 3 13 122 view .LVU95
...
.LBE286:
.LBE285:
	.loc 3 13 122 discriminator 2 view .LVU130
	movq	%rsp, %rdx
	movl	$_ZTTN3mpp10exceptions13MissingDBInfoE+24, %esi
	movq	%rbx, %rdi
.LEHB5:
...
.LBE337:
.LBE325:
	.loc 3 13 122 discriminator 1 view .LVU173
	movq	%r12, %rdi
	call	_ZNSt11logic_errorD2Ev
.LVL71:
	movq	%rbx, %rdi
...
.LEHE6:
.L30:
	.loc 3 13 122 discriminator 1 view .LVU174
	movq	%rax, %rbx
.LVL73:
	.loc 3 13 122 discriminator 1 view .LVU175
	jmp	.L29
.LBE340:
	.cfi_endproc
.LFE1377:
