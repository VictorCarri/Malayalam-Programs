...
.LBB182:
	...
	movq	$_ZTVN3mpp10exceptions13MissingDBInfoE+24, (%rdi)
	movq	$_ZTVN3mpp10exceptions13MissingDBInfoE+72, 8(%rdi)
.LVL1:
.LBB183:
.LBI183:
...
.LFB1709:
	...
	movq	(%rdi), %rax
	addq	-24(%rax), %rbx
	movq	$_ZTVN3mpp10exceptions13MissingDBInfoE+24, (%rbx)
	movq	$_ZTVN3mpp10exceptions13MissingDBInfoE+72, 8(%rbx)
...
.LFB1241:
	...
	movq	%rsi, %rbp
.LBB193:
	.loc 3 21 116 view .LVU19
	leaq	8(%rsi), %rsi
.LVL14:
	.loc 3 21 116 view .LVU20
	call	_ZN3mpp10exceptions9ExceptionC2EPc
.LVL15:
	.loc 3 21 116 view .LVU21
	movq	0(%rbp), %rax
	movq	%rax, (%rbx)
	movq	24(%rbp), %rax
	movq	%rax, 8(%rbx)
...
.LVL20:
.LEHE0:
	.loc 3 21 116 view .LVU29
	movq	%rbp, %rdx
	movl	$_ZTTN3mpp10exceptions13MissingDBInfoE+8, %esi
	movq	%rbx, %rdi
.LEHB1:
	call	_ZN3mpp10exceptions9ExceptionC2EPc
.LVL21:
.LEHE1:
	.loc 3 21 116 discriminator 2 view .LVU30
	movq	$_ZTVN3mpp10exceptions13MissingDBInfoE+24, (%rbx)
	movq	$_ZTVN3mpp10exceptions13MissingDBInfoE+72, 8(%rbx)
.LBE194:
...
.LBE353:
.LBE347:
	.loc 3 13 122 discriminator 1 view .LVU162
	movq	%r12, %rdi
	call	_ZNSt11logic_errorD2Ev
.LVL70:
	movq	%rbx, %rdi
...
.LEHE6:
.L29:
	.loc 3 13 122 view .LVU163
	movq	%rax, %rbx
.LVL72:
	.loc 3 13 122 view .LVU164
	jmp	.L28
.LBE354:
	.cfi_endproc
.LFE1239:
...
_ZTSN3mpp10exceptions13MissingDBInfoE:
	...
	.size	_ZTIN3mpp10exceptions13MissingDBInfoE, 24
...
_ZTCN3mpp10exceptions13MissingDBInfoE0_NS0_9ExceptionE:
	...
	.size	_ZTTN3mpp10exceptions13MissingDBInfoE, 32
_ZTTN3mpp10exceptions13MissingDBInfoE:
	.quad	_ZTVN3mpp10exceptions13MissingDBInfoE+24
	...
	.quad	_ZTVN3mpp10exceptions13MissingDBInfoE+72
	...
	.size	_ZTVN3mpp10exceptions13MissingDBInfoE, 96
...
.Ldebug_info0:
	...
	.uleb128 0x9
	.byte	0x3
	.quad	_ZTTN3mpp10exceptions13MissingDBInfoE+8
	.uleb128 0x10
	.uleb128 0x1
	.byte	0x51
	.uleb128 0x2
