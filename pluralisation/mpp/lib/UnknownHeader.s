...
.LVL2:
	...
	movq	$_ZTCN3mpp10exceptions13UnknownHeaderE0_NS0_9ExceptionE+72, 8(%rax)
.LVL3:
...
.LEHE0:
	...
	movq	%rbp, %rdx
	movl	$_ZTTN3mpp10exceptions13UnknownHeaderE+24, %esi
	movq	%rbx, %rdi
.LEHB1:
...
.LEHE1:
	...
	movq	$_ZTVN3mpp10exceptions13UnknownHeaderE+40, (%rbx)
	movq	$_ZTVN3mpp10exceptions13UnknownHeaderE+88, 8(%rbx)
.LBE275:
...
.LFB1371:
	...
	movq	%rsi, %rbp
.LBB306:
	.loc 3 13 119 view .LVU112
	leaq	8(%rdi), %r12
	movq	%r12, %rdi
.LVL60:
.LEHB3:
	.loc 3 13 119 view .LVU113
...
.LBE308:
.LBE307:
	.loc 3 13 119 discriminator 2 view .LVU148
	movq	%rsp, %rdx
	movl	$_ZTTN3mpp10exceptions13UnknownHeaderE+24, %esi
	movq	%rbx, %rdi
.LEHB5:
...
.LBE357:
.LBE346:
	.loc 3 13 119 discriminator 1 view .LVU191
	movq	%r12, %rdi
	call	_ZNSt11logic_errorD2Ev
.LVL79:
	movq	%rbx, %rdi
...
.LEHE6:
.L36:
	.loc 3 13 119 discriminator 1 view .LVU192
	movq	%rax, %rbx
.LVL81:
	.loc 3 13 119 discriminator 1 view .LVU193
	jmp	.L35
.LBE360:
	.cfi_endproc
.LFE1371:
