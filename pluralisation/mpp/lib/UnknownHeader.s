...
.LFB1377:
	...
	movq	%rsi, %rbp
.LBB407:
	.loc 3 13 119 view .LVU173
	leaq	8(%rdi), %r12
	movq	%r12, %rdi
.LVL73:
.LEHB6:
	.loc 3 13 119 view .LVU174
...
.LBE409:
.LBE408:
	.loc 3 13 119 discriminator 2 view .LVU209
	movq	%rsp, %rdx
	movl	$_ZTTN3mpp10exceptions13UnknownHeaderE+8, %esi
	movq	%rbx, %rdi
.LEHB8:
...
.LBE460:
.LBE448:
	.loc 3 13 119 discriminator 1 view .LVU252
	movq	%r12, %rdi
	call	_ZNSt11logic_errorD2Ev
.LVL92:
	movq	%rbx, %rdi
...
.LEHE9:
.L37:
	.loc 3 13 119 discriminator 1 view .LVU253
	movq	%rax, %rbx
.LVL94:
	.loc 3 13 119 discriminator 1 view .LVU254
	jmp	.L36
.LBE463:
	.cfi_endproc
.LFE1377:
